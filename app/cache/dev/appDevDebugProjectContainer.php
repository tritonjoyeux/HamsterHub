...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'ap_user.edit.form.type' => 'getApUser_Edit_Form_TypeService',
    ...
    /**
     * Gets the 'ap_user.edit.form.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \HamsterHubBundle\Form\Profil A HamsterHubBundle\Form\Profil instance.
     */
    protected function getApUser_Edit_Form_TypeService()
    {
        return $this->services['ap_user.edit.form.type'] = new \HamsterHubBundle\Form\Profil('HamsterHubBundle\\Entity\\User');
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \HamsterHubBundle\Form\RegistrationType A HamsterHubBundle\Form\RegistrationType instance.
     */
    protected function getApp_Form_RegistrationService()
    {
        return $this->services['app.form.registration'] = new \HamsterHubBundle\Form\RegistrationType();
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'\\src\\HamsterHubBundle\\Resources\\config\\doctrine') => 'HamsterHubBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'HamsterHubBundle\\Entity');
        ...
        $c->setEntityNamespaces(array('HamsterHubBundle' => 'HamsterHubBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_7aba899a2b9fefdc80b8441e12fbc7d3558c9857171210142deb0295d2590d3e');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('HamsterHubBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_profile_form', 'HamsterHubBundle\\Form\\ProfilType', array(0 => 'Profile', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('HamsterHubBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_registration_form', 'HamsterHubBundle\\Form\\RegistrationType', array(0 => 'Registration', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('HamsterHubBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('HamsterHubBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'HamsterHubBundle\\Entity\\User');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/my_video');

        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/profile/picture');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('ae2ab095c7a1e48c7cb00764e594916832d3ba1f');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => 'ae2ab095c7a1e48c7cb00764e594916832d3ba1f',
            'locale' => 'en',
            ...
            'kernel.secret' => 'ae2ab095c7a1e48c7cb00764e594916832d3ba1f',
            ...
            'fos_user.model.user.class' => 'HamsterHubBundle\\Entity\\User',
            'fos_user.profile.form.type' => 'HamsterHubBundle\\Form\\ProfilType',
            ...
            'fos_user.registration.form.type' => 'HamsterHubBundle\\Form\\RegistrationType',
